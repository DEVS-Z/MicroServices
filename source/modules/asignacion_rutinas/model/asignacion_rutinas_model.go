...
type Asignacion_rutinasStruct struct {
	AsignacionId *int `db:"asignacion_id" sanitizer:"id" visible:"false"`
...
var Model = base_models.NewModel[Asignacion_rutinasStruct]("asignacion_rutinas", "asignacion_rutinas")
